...
Mollick được dùng để phân lại quyền: AI tìm và tóm tắt; nhân viên kiểm nguồn; SME/quản lý phê duyệt ngoại lệ và chịu trách nhiệm cuối. Gartner-Lite cho thấy Direction đạt nhưng Readiness và Absorption thiếu data owner, lịch cập nhật, ACL, owner chất lượng và vòng phản hồi. ADKAR xác định nghẽn ở Awareness/Desire vì người dùng chưa rõ phạm vi dùng và không tin câu trả lời thiếu nguồn; vì vậy đào tạo đơn lẻ không đủ. Bằng chứng hiện có là dấu hiệu quan sát trong brief case của Lab; dữ liệu định lượng sẽ lấy từ task log, click log, QA checklist và security log trong tuần 1. Tham chiếu quản trị: NIST AI RMF — https://airc.nist.gov/RMF.
...
2. Bổ sung RACI trong TO-BE: con người giữ quyền quyết định cuối, SME nhận ngoại lệ, AI Product Owner sở hữu chất lượng và vòng phản hồi.
...
Hai nguyên nhân gốc có thể xử lý trong phạm vi hẹp và kiểm chứng bằng dữ liệu thu được từ workflow. Trong 0–30 ngày, AI Product Owner khoá bốn workflow pilot, danh mục nguồn, ACL, data owner và baseline. Ngày 31–60, QA Lead bật QA mẫu 10%, theo dõi citation/rework và hỗ trợ người dùng ngay trong workflow. Ngày 61–90, Chủ quy trình cùng Sponsor đối chiếu mục tiêu, kiểm governance và chốt mở rộng, sửa thêm hoặc dừng.

> Trước khi nộp: thay bằng tên owner thật và bổ sung tên nhóm phản biện trong README.
